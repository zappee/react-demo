...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EditProfile = __webpack_require__(234);

	var _EditProfile2 = _interopRequireDefault(_EditProfile);

	var _RestDemo = __webpack_require__(235);

	var _RestDemo2 = _interopRequireDefault(_RestDemo);

	var _ChangeProfilePhoto = __webpack_require__(237);

	var _ChangeProfilePhoto2 = _interopRequireDefault(_ChangeProfilePhoto);

	var _Messages = __webpack_require__(238);

	var _Messages2 = _interopRequireDefault(_Messages);

	var _WriteNewMessage = __webpack_require__(239);

	var _WriteNewMessage2 = _interopRequireDefault(_WriteNewMessage);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(
	    _reactRouter.Router /*history={browserHistory}*/,
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.Route, { path: 'restDemo', component: _RestDemo2.default }),
	        _react2.default.createElement(
	            _reactRouter.Route,
	            { path: 'profile' },
	            _react2.default.createElement(_reactRouter.Route, { path: 'edit', component: _EditProfile2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'changeProfilePhoto', component: _ChangeProfilePhoto2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'messages', component: _Messages2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'newMessage', component: _WriteNewMessage2.default })
	        )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainMenu = __webpack_require__(230);
	    ...
	    _createClass(MainLayout, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_MainMenu2.default, { path: this.props.location.pathname }),
	                _react2.default.createElement(
	                    'main',
	                    null,
	                    this.props.children
	    ...
	    _createClass(Contact, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'a',
	                    { href: 'mailto:arnold.somogyi@gmail.com' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditProfile = function (_React$Component) {
	    ...
	    function EditProfile() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(EditProfile).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RestDemoWrapper = function (_React$Component) {
	    _inherits(RestDemoWrapper, _React$Component);

	    function RestDemoWrapper() {
	        _classCallCheck(this, RestDemoWrapper);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RestDemoWrapper).apply(this, arguments));
	    }

	    _createClass(RestDemoWrapper, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(RestDemo, { nickName: 'soma', imageSrc: 'http://www.freelargeimages.com/wp-content/uploads/2014/12/Face_clip_art.png' });
	        }
	    }]);

	    return RestDemoWrapper;
	}(_react2.default.Component);
	...
	exports.default = RestDemoWrapper;

	var RestDemo = function (_React$Component2) {
	    _inherits(RestDemo, _React$Component2);

	    _createClass(RestDemo, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            .then(function (json) {
	                ...
	                _this3.setState({ countries: json.RestResponse.result });
	            });
	        }
	        ...
	        value: function propTypes() {
	            nickName: _react2.default.PropTypes.string.isRequired;
	            imageSrc: _react2.default.PropTypes.string.isRequired;
	        }
	    }]);

	    function RestDemo(props) {
	        _classCallCheck(this, RestDemo);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(RestDemo).call(this, props));

	        _this2.state = { countries: [] };
	        return _this2;
	    }
	    ...
	    _createClass(RestDemo, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                null,
	                this.props.nickName,
	                _react2.default.createElement('img', { style: style.photo, alt: this.props.nickName + '\'s profile photo', src: this.props.imageSrc }),
	                _react2.default.createElement(CountryList, { countries: this.state.countries })
	            );
	        }
	    }]);
	...
	var CountryList = function (_React$Component3) {
	    _inherits(CountryList, _React$Component3);

	    function CountryList() {
	        _classCallCheck(this, CountryList);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(CountryList).apply(this, arguments));
	    }

	    _createClass(CountryList, [{
	        key: 'render',
	        value: function render() {
	            var countryName = this.props.countries.map(function (country) {
	                return country.name == "Hungary" ? _react2.default.createElement(
	                    'p',
	                    { style: style.redText },
	                    country.name
	                ) : _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChangeProfilePhoto = function (_React$Component) {
	    _inherits(ChangeProfilePhoto, _React$Component);

	    function ChangeProfilePhoto() {
	        _classCallCheck(this, ChangeProfilePhoto);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ChangeProfilePhoto).apply(this, arguments));
	    }

	    _createClass(ChangeProfilePhoto, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	...
	exports.default = ChangeProfilePhoto;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WriteNewMessage = function (_React$Component) {
	    _inherits(WriteNewMessage, _React$Component);

	    function WriteNewMessage() {
	        _classCallCheck(this, WriteNewMessage);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(WriteNewMessage).apply(this, arguments));
	    }

	    _createClass(WriteNewMessage, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	    ...
	    return WriteNewMessage;
	}(_react2.default.Component);

	exports.default = WriteNewMessage;
